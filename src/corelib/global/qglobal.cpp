...
PFNGETMONITORINFOA pfnGetMonitorInfoA;
PFNGETMONITORINFOW pfnGetMonitorInfoW;
PFNGETWINDOWRGN pfnGetWindowRgn;
PFNMSGWAITFORMULTIPLEOBJECTSEX pfnMsgWaitForMultipleObjectsEx;
PFNSETLAYEREDWINDOWATTRIBUTES pfnSetLayeredWindowAttributes;
PFNSETWINDOWRGN pfnSetWindowRgn;
...
PFNSHGETMALLOC pfnSHGetMalloc;
PFNSHGETPATHFROMIDLISTA pfnSHGetPathFromIDListA;
PFNSHGETPATHFROMIDLISTW pfnSHGetPathFromIDListW;
PFNSHBROWSEFORFOLDERA pfnSHBrowseForFolderA;
PFNSHBROWSEFORFOLDERW pfnSHBrowseForFolderW;
...
PFNACCEPT pfnaccept;
PFNBIND pfnbind;
PFNCLOSESOCKET pfnclosesocket;
PFNCONNECT pfnconnect;
PFNGETHOSTBYNAME pfngethostbyname;
PFNGETHOSTNAME pfngethostname;
PFNGETPEERNAME pfngetpeername;
PFNGETSOCKNAME pfngetsockname;
PFNGETSOCKOPT pfngetsockopt;
PFNHTONL pfnhtonl;
PFNHTONS pfnhtons;
PFNIOCTLSOCKET pfnioctlsocket;
PFNLISTEN pfnlisten;
PFNNTOHL pfnntohl;
PFNNTOHS pfnntohs;
PFNRECV pfnrecv;
PFNRECVFROM pfnrecvfrom;
PFNSELECT pfnselect;
PFNSEND pfnsend;
PFNSENDTO pfnsendto;
PFNSETSOCKOPT pfnsetsockopt;
PFNSOCKET pfnsocket;
PFNWSAACCEPT pfnWSAAccept;
PFNWSAASYNCSELECT pfnWSAAsyncSelect;
PFNWSACLEANUP pfnWSACleanup;
PFNWSACONNECT pfnWSAConnect;
PFNWSAGETLASTERROR pfnWSAGetLastError;
PFNWSAIOCTL pfnWSAIoctl;
PFNWSARECV pfnWSARecv;
PFNWSARECVFROM pfnWSARecvFrom;
PFNWSASEND pfnWSASend;
PFNWSASENDTO pfnWSASendTo;
PFNWSASOCKETA pfnWSASocketA;
